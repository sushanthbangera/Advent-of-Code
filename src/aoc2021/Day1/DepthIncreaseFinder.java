...
public class DepthIncreaseFinder {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getIncreasedDepthCount2(input1));
        ...
        System.out.println(getIncreasedDepthCount2(input2));
    }
    ...
    public static int  getIncreasedDepthCount2(List<String> input) {
        List<Integer> depths = NumberUtils.convertToInt(input);
        int result = 0;
        int prev = - 1;
        int currentSum = 0;
